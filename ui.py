...
class Ui_GraphsApp(object):
    def setupUi(self, GraphsApp):
        ...
        self.label_4.setGeometry(QtCore.QRect(10, 160, 16, 31))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.minX = QtWidgets.QSpinBox(self.tab)
        self.minX.setGeometry(QtCore.QRect(80, 160, 61, 31))
        self.minX.setMinimum(-100)
        self.minX.setMaximum(100)
        self.minX.setProperty("value", -10)
        ...
        self.label_6.setGeometry(QtCore.QRect(150, 160, 31, 31))
        font = QtGui.QFont()
        ...
        self.label_7.setGeometry(QtCore.QRect(40, 160, 31, 30))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.maxX = QtWidgets.QSpinBox(self.tab)
        self.maxX.setGeometry(QtCore.QRect(190, 160, 61, 31))
        self.maxX.setMinimum(-100)
        self.maxX.setMaximum(100)
        self.maxX.setProperty("value", 10)
    ...
    def retranslateUi(self, GraphsApp):
        ...
        self.label_6.setText(_translate("GraphsApp", "до"))
        self.label_7.setText(_translate("GraphsApp", "от"))
